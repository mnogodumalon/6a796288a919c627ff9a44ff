...
INTENT_BUILDER_PROMPT = (
    ...
    "descriptions, empty states, tooltips) goes through makeT from '@/i18n': define de AND en "
    "once at the top of the page, render {tt('key')}. Standard words are pre-translated in tc "
    "from '@/i18n/common' — use its keys. Scaffold text via t()/appLabel()/fieldLabel()/"
    "lookupLabel(). check-intents flags hardcoded strings.\n"
    """
