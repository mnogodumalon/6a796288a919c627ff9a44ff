...
// <custom:intent-imports>
import { IconTool, IconArrowBack } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/werkzeug-ausleihen', label: { de: 'Werkzeug ausleihen', en: 'Borrow tool' }, icon: IconTool, description: 'Werkzeug in 3 Schritten an einen Handwerker ausleihen' },
  { path: '/intents/werkzeug-rueckgabe', label: { de: 'Werkzeug zurückgeben', en: 'Return tool' }, icon: IconArrowBack, description: 'Ausleihe abschließen und Werkzeugzustand dokumentieren' },
  // </custom:intents>
];
