...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/werkzeug-ausleihen', label: { de: 'Werkzeug ausleihen', en: 'Borrow tool' }, icon: IconHandStop, description: 'Werkzeug an Handwerker ausleihen' },
  { path: '/intents/werkzeug-rueckgabe', label: { de: 'Werkzeug zurückgeben', en: 'Return tool' }, icon: IconArrowBack, description: 'Ausleihe abschließen und Werkzeugzustand aktualisieren' },
  // </custom:intents>
];
