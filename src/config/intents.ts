...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/werkzeug-rueckgabe', label: { de: 'Werkzeug zurückgeben', en: 'Return tool' }, icon: IconToolsOff, description: 'Rückgabe erfassen und Zustand aktualisieren' },
  // </custom:intents>
];
