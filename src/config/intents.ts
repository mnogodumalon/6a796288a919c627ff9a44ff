...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/werkzeug-ausleihen', label: { de: 'Werkzeug ausleihen', en: 'Borrow tool' }, icon: IconTool, description: 'Handwerker und Werkzeug wählen, Ausleihe anlegen' },
  { path: '/intents/werkzeug-rueckgabe', label: { de: 'Werkzeug zurückgeben', en: 'Return tool' }, icon: IconArrowBack, description: 'Ausleihe abschließen und Zustand aktualisieren' },
  // </custom:intents>
];
