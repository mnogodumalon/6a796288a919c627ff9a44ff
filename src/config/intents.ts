...
// <custom:intent-imports>
import { IconTool, IconToolsOff, IconHammer } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/werkzeug-ausleihen', label: { de: 'Werkzeug ausleihen', en: 'Borrow tool' }, icon: IconTool, description: 'Werkzeug an Handwerker ausleihen' },
  { path: '/intents/werkzeug-rueckgabe', label: { de: 'Werkzeug zurückgeben', en: 'Return tool' }, icon: IconToolsOff, description: 'Ausleihe abschließen und Werkzeugstatus aktualisieren' },
  { path: '/intents/wartung-abschliessen', label: { de: 'Wartung abschließen', en: 'Close maintenance' }, icon: IconHammer, description: 'Laufende Wartung oder Reparatur abschließen' },
  // </custom:intents>
];
