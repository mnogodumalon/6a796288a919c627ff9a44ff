...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/werkzeug-verleihen', label: { de: 'Werkzeug verleihen', en: 'Lend tool' }, icon: IconTool, description: 'Handwerker und Werkzeug wählen, Ausleihe anlegen' },
  { path: '/intents/werkzeug-rueckgabe', label: { de: 'Werkzeug zurückgeben', en: 'Return tool' }, icon: IconToolsOff, description: 'Ausleihe abschließen, Zustand erfassen, Wartung anlegen' },
  // </custom:intents>
];
