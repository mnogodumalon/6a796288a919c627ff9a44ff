...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/werkzeug-ausleihen', label: { de: 'Werkzeug ausleihen', en: 'Borrow Tool' }, icon: IconTool, description: 'Werkzeug in 3 Schritten an Handwerker ausleihen' },
  { path: '/intents/werkzeug-rueckgabe', label: { de: 'Rückgabe & Wartung', en: 'Return & Maintenance' }, icon: IconToolsOff, description: 'Ausleihe abschließen und optional Wartung anlegen' },
  // </custom:intents>
];
