...
// <custom:intent-imports>
import { IconHandGrab, IconArrowBackUp } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/werkzeug-ausleihen', label: { de: 'Werkzeug ausleihen', en: 'Borrow tool' }, icon: IconHandGrab, description: 'Handwerker und Werkzeug wählen und Ausleihe anlegen' },
  { path: '/intents/werkzeug-rueckgabe', label: { de: 'Werkzeug zurückgeben', en: 'Return tool' }, icon: IconArrowBackUp, description: 'Ausleihe abschließen und Wartungsbedarf melden' },
  // </custom:intents>
];
