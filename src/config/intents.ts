...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/werkzeug-rueckgabe', label: { de: 'Werkzeug zurückgeben', en: 'Return tool' }, icon: IconToolsOff, description: 'Ausleihe abschließen und optional Wartung erfassen' },
  // </custom:intents>
];
