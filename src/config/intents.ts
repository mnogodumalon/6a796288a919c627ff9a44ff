...
// <custom:intent-imports>
import { IconHandStop, IconArrowBack } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/werkzeug-ausleihen', label: { de: 'Werkzeug ausleihen', en: 'Borrow tool' }, icon: IconHandStop, description: 'Werkzeug in 3 Schritten an einen Handwerker ausleihen' },
  { path: '/intents/werkzeug-rueckgabe', label: { de: 'Werkzeug zurückgeben', en: 'Return tool' }, icon: IconArrowBack, description: 'Ausleihe abschließen und optional Wartung einleiten' },
  // </custom:intents>
];
