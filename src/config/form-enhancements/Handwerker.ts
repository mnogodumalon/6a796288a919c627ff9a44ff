// Auto-generated. Per-entity form-enhancements config for "Handwerker".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: [{ row: ["vorname", "nachname"] }, "personalnummer", "telefon", "email", "abteilung", "qualifikation", "status", "bemerkungen"],
  defaults: {
