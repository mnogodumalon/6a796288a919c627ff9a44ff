...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['werkzeug', 'handwerker', 'ausleihdatum', 'geplanes_rueckgabedatum', 'tatsaechliches_rueckgabedatum', 'status_ausleihe', 'bemerkungen_ausleihe'],
  defaults: {
    'ausleihdatum': { kind: 'today', withTime: true },
    'geplanes_rueckgabedatum': { kind: 'todayOffset', days: 7, withTime: true },
    'status_ausleihe': { kind: 'lookup', key: 'ausgeliehen', label: 'Ausgeliehen' },
  },
  computed: {
    '_ausleihe_dauer_tage': { kind: 'dateDiff', from: 'ausleihdatum', to: 'geplanes_rueckgabedatum', unit: 'days' },
  },
};
