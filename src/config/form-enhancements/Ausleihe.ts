...
export const formEnhancements: FormEnhancements = {
  fieldOrder: [
    "werkzeug",
    "handwerker",
    { row: ["ausleihdatum", "geplantes_rueckgabedatum"] },
  ...
  defaults: {
    ...
    'geplantes_rueckgabedatum': { kind: 'todayOffset', days: 1, withTime: true },
    'status_ausleihe': { kind: 'lookup', key: 'ausgeliehen', label: 'Ausgeliehen' },
  },
  computed: {
    '_ausleihe_dauer_stunden': { kind: 'dateDiff', from: 'ausleihdatum', to: 'tatsaechliches_rueckgabedatum', unit: 'hours' },
  },
};
