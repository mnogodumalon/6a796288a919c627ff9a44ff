...
export const formEnhancements: FormEnhancements = {
  fieldOrder: [
    ...
    'vorgangsart',
    'verantwortlicher',
    { row: ['startdatum', 'geplantes_enddatum'], cols: '1fr 1fr' },
  ...
  computed: {
    '_wartung_dauer_geplant_tage': { kind: 'dateDiff', from: 'startdatum', to: 'geplantes_enddatum', unit: 'days' },
    '_wartung_dauer_tatsaechlich_tage': { kind: 'dateDiff', from: 'startdatum', to: 'tatsaechliches_enddatum', unit: 'days' },
  },
};
