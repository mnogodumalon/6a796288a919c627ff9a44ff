// Auto-generated. Per-entity form-enhancements config for "Wartung & Reparatur".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["werkzeug_wartung", "vorgangsart", "verantwortlicher", {"row": ["startdatum", "geplantes_enddatum"]}, "tatsaechliches_enddatum", "beschreibung", "status_wartung", "kosten", "bemerkungen_wartung"],
  defaults: {
    'startdatum': { kind: 'today' },
    'status_wartung': { kind: 'lookup', key: 'geplant', label: 'Geplant' },
  },
  computed: {
    '_wartung_geplante_dauer_tage': { kind: 'dateDiff', from: 'startdatum', to: 'geplantes_enddatum', unit: 'days' },
    '_wartung_tatsaechliche_dauer_tage': { kind: 'dateDiff', from: 'startdatum', to: 'tatsaechliches_enddatum', unit: 'days' },
  },
};
