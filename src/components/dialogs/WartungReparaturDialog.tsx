  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Was ist das Problem? Welche Arbeiten werden durchgeführt? Details der Maßnahme.."
    ...
    'bemerkungen_wartung': (
      <div key="bemerkungen_wartung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Ersatzteile, Lieferant, Kontrollnummern, Notizen..."
