  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'verantwortlicher': (
      <div key="verantwortlicher" className="space-y-1.5">
        ...
        <Combobox
          id="verantwortlicher"
          placeholder="Zuständiger Handwerker?"
    ...
    'tatsaechliches_enddatum': (
      <div key="tatsaechliches_enddatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Tatsächliches Ende?"
          mode="date"
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Problem, Symptome, durchgeführte Maßnahmen..."
    ...
    'bemerkungen_wartung': (
      <div key="bemerkungen_wartung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Weitere Informationen, Ersatzteile..."
