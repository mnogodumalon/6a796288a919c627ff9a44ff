  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'startdatum': (
      <div key="startdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="startdatum"
          placeholder="Wann beginnt der Vorgang?"
          mode="date"
    ...
    'geplantes_enddatum': (
      <div key="geplantes_enddatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Geplantes Abschlussdatum"
          mode="date"
    ...
    'tatsaechliches_enddatum': (
      <div key="tatsaechliches_enddatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Tatsächliches Abschlussdatum"
          mode="date"
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Fehler, Problem oder Wartungsumfang ausführlich beschreiben..."
    ...
    'bemerkungen_wartung': (
      <div key="bemerkungen_wartung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Zusätzliche Informationen, Austauschteile, Besonderheiten..."
