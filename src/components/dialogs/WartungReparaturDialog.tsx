  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'werkzeug_wartung': (
      <div key="werkzeug_wartung" className="space-y-1.5">
        ...
        <Combobox
          id="werkzeug_wartung"
          placeholder="Welches Werkzeug braucht Wartung?"
    ...
    'verantwortlicher': (
      <div key="verantwortlicher" className="space-y-1.5">
        ...
        <Combobox
          id="verantwortlicher"
          placeholder="Wer kümmert sich drum?"
    ...
    'startdatum': (
      <div key="startdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="startdatum"
          placeholder="Wann startet die Maßnahme?"
          mode="date"
    ...
    'geplantes_enddatum': (
      <div key="geplantes_enddatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Geplantes Abschluss-Datum?"
          mode="date"
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Was ist das Problem? Welche Maßnahmen notwendig?"
    ...
    'bemerkungen_wartung': (
      <div key="bemerkungen_wartung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Ersatzteile, Besonderheiten, Lieferant..."
