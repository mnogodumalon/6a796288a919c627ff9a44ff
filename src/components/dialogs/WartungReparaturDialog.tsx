  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'geplantes_enddatum': (
      <div key="geplantes_enddatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Wann sollte fertig sein?"
          mode="date"
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Fehler, Schaden, durchgeführte Maßnahmen, Teile augetauscht..."
