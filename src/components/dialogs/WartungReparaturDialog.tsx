  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'werkzeug_wartung': (
      <div key="werkzeug_wartung" className="space-y-1.5">
        ...
        <Combobox
          id="werkzeug_wartung"
          placeholder="Welches Werkzeug wird bearbeitet?"
    ...
    'startdatum': (
      <div key="startdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="startdatum"
          placeholder="Wann beginnt die Bearbeitung?"
          mode="date"
    ...
    'geplantes_enddatum': (
      <div key="geplantes_enddatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Geplanter Fertigstellungstag?"
          mode="date"
    ...
    'tatsaechliches_enddatum': (
      <div key="tatsaechliches_enddatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Wann wurde fertiggestellt?"
          mode="date"
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Problem, Maßnahme, Ergebnis..."
    ...
    'bemerkungen_wartung': (
      <div key="bemerkungen_wartung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Zusätzliche Hinweise, Teile, Lieferanten..."
