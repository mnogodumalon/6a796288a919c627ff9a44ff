  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'werkzeug_wartung': (
      <div key="werkzeug_wartung" className="space-y-1.5">
        ...
        <Combobox
          id="werkzeug_wartung"
          placeholder="Welches Werkzeug betroffen?"
    ...
    'verantwortlicher': (
      <div key="verantwortlicher" className="space-y-1.5">
        ...
        <Combobox
          id="verantwortlicher"
          placeholder="Verantwortlicher Handwerker?"
    ...
    'startdatum': (
      <div key="startdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="startdatum"
          placeholder="Wann wird begonnen?"
          mode="date"
    ...
    'geplantes_enddatum': (
      <div key="geplantes_enddatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Wann fertig geplant?"
          mode="date"
    ...
    'tatsaechliches_enddatum': (
      <div key="tatsaechliches_enddatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Wann tatsächlich fertig?"
          mode="date"
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Was ist das Problem, welche Maßnahmen werden durchgeführt?"
    ...
    'bemerkungen_wartung': (
      <div key="bemerkungen_wartung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Ersatzteile, besondere Erkenntnisse, Folgemaßnahmen…"
