  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'tatsaechliches_enddatum': (
      <div key="tatsaechliches_enddatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Wann wurde es tatsächlich fertig?"
          mode="date"
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Was ist das Problem oder die Maßnahme?"
    ...
    'bemerkungen_wartung': (
      <div key="bemerkungen_wartung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Ergebnis, Besonderheiten, Empfehlungen für Zukunft..."
