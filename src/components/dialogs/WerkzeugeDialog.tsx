  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'werkzeugname': (
      <div key="werkzeugname" className="space-y-1.5">
        ...
        <Input
          id="werkzeugname"
          placeholder="z. B. Bohrmaschine Makita"
    ...
    'kategorie': (
      <div key="kategorie" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="kategorie" className="max-sm:h-11"><SelectValue placeholder="Welche Kategorie passt?" /></SelectTrigger>
          <SelectContent>
    ...
    'zustand': (
      <div key="zustand" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="zustand" className="max-sm:h-11"><SelectValue placeholder="Aktueller Zustand wählen" /></SelectTrigger>
          <SelectContent>
            <SelectItem value="none">—</SelectItem>
    ...
    'bemerkungen_werkzeug': (
      <div key="bemerkungen_werkzeug" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Besonderheiten, Wartungshinweise..."
