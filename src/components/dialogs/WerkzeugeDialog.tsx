  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'kategorie': (
      <div key="kategorie" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="kategorie" className="max-sm:h-11"><SelectValue placeholder="z. B. Elektrowerkzeug" /></SelectTrigger>
          <SelectContent>
    ...
    'anschaffungsdatum': (
      <div key="anschaffungsdatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Wann wurde angeschafft?"
          mode="date"
    ...
    'standort': (
      <div key="standort" className="space-y-1.5">
        ...
        <Input
          id="standort"
          placeholder="z. B. Lager Ost, Regal A2"
    ...
    'zustand': (
      <div key="zustand" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="zustand" className="max-sm:h-11"><SelectValue placeholder="Wähle den Zustand" /></SelectTrigger>
          <SelectContent>
            <SelectItem value="none">—</SelectItem>
    ...
    'bemerkungen_werkzeug': (
      <div key="bemerkungen_werkzeug" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Wartungshistorie, Besonderheiten, Schäden..."
