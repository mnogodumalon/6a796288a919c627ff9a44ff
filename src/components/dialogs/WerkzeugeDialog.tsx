  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'anschaffungsdatum': (
      <div key="anschaffungsdatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Wann wurde das Werkzeug gekauft?"
          mode="date"
    ...
    'zustand': (
      <div key="zustand" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="zustand" className="max-sm:h-11"><SelectValue placeholder="Wie ist der aktuelle Zustand?" /></SelectTrigger>
          <SelectContent>
            <SelectItem value="none">—</SelectItem>
    ...
    'bemerkungen_werkzeug': (
      <div key="bemerkungen_werkzeug" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Defekte, Verschleiß, Reparaturhistorie..."
