  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'werkzeugname': (
      <div key="werkzeugname" className="space-y-1.5">
        ...
        <Input
          id="werkzeugname"
          placeholder="z. B. Bohrmaschine 500W"
    ...
    'inventarnummer': (
      <div key="inventarnummer" className="space-y-1.5">
        ...
        <Input
          id="inventarnummer"
          placeholder="z. B. WZ-20250815-001"
    ...
    'kategorie': (
      <div key="kategorie" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="kategorie" className="max-sm:h-11"><SelectValue placeholder="Wähle Kategorie" /></SelectTrigger>
          <SelectContent>
    ...
    'anschaffungsdatum': (
      <div key="anschaffungsdatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Wann wurde gekauft?"
          mode="date"
    ...
    'standort': (
      <div key="standort" className="space-y-1.5">
        ...
        <Input
          id="standort"
          placeholder="z. B. Lager Nord, Regal 3"
    ...
    'zustand': (
      <div key="zustand" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="zustand" className="max-sm:h-11"><SelectValue placeholder="Wähle Zustand" /></SelectTrigger>
          <SelectContent>
            <SelectItem value="none">—</SelectItem>
