  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'werkzeugname': (
      <div key="werkzeugname" className="space-y-1.5">
        ...
        <Input
          id="werkzeugname"
          placeholder="z. B. Bohrmaschine Metabo"
    ...
    'kategorie': (
      <div key="kategorie" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="kategorie" className="max-sm:h-11"><SelectValue placeholder="Kategorie des Werkzeugs wählen" /></SelectTrigger>
          <SelectContent>
    ...
    'hersteller': (
      <div key="hersteller" className="space-y-1.5">
        ...
        <Input
          id="hersteller"
          placeholder="z. B. Bosch, Makita, Hilti"
    ...
    'standort': (
      <div key="standort" className="space-y-1.5">
        ...
        <Input
          id="standort"
          placeholder="z. B. Werkstatt Lager A2"
    ...
    'zustand': (
      <div key="zustand" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="zustand" className="max-sm:h-11"><SelectValue placeholder="Verfügbar, Ausgeliehen, Defekt?" /></SelectTrigger>
          <SelectContent>
            <SelectItem value="none">—</SelectItem>
    ...
    'bemerkungen_werkzeug': (
      <div key="bemerkungen_werkzeug" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Ausstattung, Besonderheiten, Wartungshinweise..."
