  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'kategorie': (
      <div key="kategorie" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="kategorie" className="max-sm:h-11"><SelectValue placeholder="z. B. Messgerät, Elektrowerkzeug" /></SelectTrigger>
          <SelectContent>
    ...
    'zustand': (
      <div key="zustand" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="zustand" className="max-sm:h-11"><SelectValue placeholder="Aktuellen Zustand wählen" /></SelectTrigger>
          <SelectContent>
            <SelectItem value="none">—</SelectItem>
    ...
    'bemerkungen_werkzeug': (
      <div key="bemerkungen_werkzeug" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Besonderheiten, Wartungsverlauf, Schäden..."
