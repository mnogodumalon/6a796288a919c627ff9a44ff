  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'handwerker': (
      <div key="handwerker" className="space-y-1.5">
        ...
        <Combobox
          id="handwerker"
          placeholder="Wer leiht sich das Werkzeug aus?"
    ...
    'ausleihdatum': (
      <div key="ausleihdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="ausleihdatum"
          placeholder="Wann wird es abgeholt?"
          mode="datetime"
    ...
    'tatsaechliches_rueckgabedatum': (
      <div key="tatsaechliches_rueckgabedatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Wann wurde es tatsächlich zurückgegeben?"
          mode="datetime"
    ...
    'bemerkungen_ausleihe': (
      <div key="bemerkungen_ausleihe" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Zustand beim Abholen, Besonderheiten, Schäden..."
