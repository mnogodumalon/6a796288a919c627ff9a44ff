...
const WartungAbschliessenPage = lazy(() => import('@/pages/intents/WartungAbschliessenPage'));
// </custom:imports>
          ...
          <ActionsProvider>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="intents/wartung-abschliessen" element={<Suspense fallback={null}><WartungAbschliessenPage /></Suspense>} />
                {/* </custom:routes> */}
              </Route>
            </Routes>
            </LocaleGate>
