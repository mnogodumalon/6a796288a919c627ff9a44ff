...
// <custom:imports>
const WerkzeugVerleihenPage = lazy(() => import('@/pages/intents/WerkzeugVerleihenPage'));
          ...
          <ActionsProvider>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                {/* <custom:routes> */}
                <Route path="intents/werkzeug-verleihen" element={<Suspense fallback={null}><WerkzeugVerleihenPage /></Suspense>} />
